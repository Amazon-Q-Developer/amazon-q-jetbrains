...
interface FeatureWithPinnedConnection {
    ...
    companion object {
        val EP_NAME = ExtensionPointName.create<FeatureWithPinnedConnection>("amazon.q.connection.pinned.feature")
    }
}

@State(name = "qConnectionPinningManager", storages = [Storage("amazonq.xml")])
